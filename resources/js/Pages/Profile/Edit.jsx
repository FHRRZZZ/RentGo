        ...
        <div className="min-h-screen bg-[#F8F9FA] text-[#111111] font-sans antialiased">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="text-xs font-bold bg-stone-100 hover:bg-red-50 hover:text-red-600 text-stone-700 px-3 py-2 rounded-sm border border-stone-200 transition-colors"
                        >
                            Keluar
                        </button>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-2">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-[#F5B800] text-[#111111] font-black flex items-center justify-center text-xl rounded-sm shadow-sm shrink-0">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="text-[11px] font-bold bg-stone-900 text-stone-300 px-3 py-1.5 rounded-sm border border-stone-700 uppercase tracking-wider">
                                Member RentGo
                            </span>
                            <span className="text-[11px] font-bold bg-[#F5B800] text-[#111111] px-3 py-1.5 rounded-sm uppercase tracking-wider">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="bg-white p-2 rounded-sm border border-stone-200 shadow-sm mb-6">
                    <div className="flex flex-wrap items-center gap-1 bg-stone-100 p-1 rounded-sm">
                        <button
                            ...
                            className={`text-xs font-bold px-4 py-2.5 rounded-sm transition-colors ${
                        ...
                        >
                            ...
                            <span className="ml-2 text-[10px] px-1.5 py-0.5 rounded-sm bg-[#F5B800] text-[#111111] font-extrabold uppercase">
                                Wajib
                            </span>
                        </button>
                ...
                <div className="mt-8 p-5 bg-stone-100 rounded-sm border border-stone-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        <p className="text-xs font-bold text-[#111111]">Butuh Bantuan Pemesanan atau Perubahan Data?</p>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs font-bold bg-[#F5B800] text-[#111111] hover:bg-[#e0a800] px-4 py-2.5 rounded-sm uppercase tracking-wider shrink-0 transition-colors"
                    >
                        Hubungi CS WhatsApp
                    </a>
                </div>
