        ...
        <section className={className}>
            ...
            <div className="p-4 bg-red-50/60 border border-red-200 rounded-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="text-xs font-medium bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-sm uppercase tracking-wider shrink-0 transition-colors"
                >
                    Hapus Akun Saya
                </button>
            </div>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6 bg-white rounded-sm">
                    ...
                    <div className="mt-4">
                        <label htmlFor="delete-password" className="block text-xs font-medium text-stone-700 mb-1">
                            Kata Sandi Akun
                        </label>
                        <input
                            id="delete-password"
                    ...
                    <div className="mt-6 flex justify-end gap-2 border-t border-stone-100 pt-4">
                        <button
                            type="button"
                            onClick={closeModal}
                            className="text-xs font-medium bg-stone-100 hover:bg-stone-200 text-stone-700 px-4 py-2 rounded-sm transition-colors"
                        >
                            Batal
                        </button>
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="text-xs font-medium bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-sm uppercase tracking-wider transition-colors disabled:opacity-50"
                        >
